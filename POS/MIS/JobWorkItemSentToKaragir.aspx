<%@ Page Title="Job Work Items Sent To Karagir" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="JobWorkItemSentToKaragir.aspx.cs" Inherits="POS.MIS.JobWorkItemBalanceQty" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMaster" runat="server">
    ...
    <div class="st-content">
        ...
        <div class="container-fluid">
            ...
            <div class="page-header">
                <h3>Job Work Item Sent to Karagir</h3>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <table id="JobWorkItemSentToKaragir" class="table table-condensed">                                            
                                        </table>                                        
                                    </div>
    ...
    <script type="text/javascript" src="../content/scripts/app/mis/job-work-items-sent-to-karagir.js"></script>
