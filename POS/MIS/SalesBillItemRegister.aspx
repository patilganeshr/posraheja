<%@ Page Title="Sales Bill Item Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SalesBillItemRegister.aspx.cs" Inherits="POS.MIS.SalesBillItemRegister" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMaster" runat="server">
    ...
    <div class="st-content">
        ...
        <div class="container-fluid">
            ...
            <div class="page-header">
                <h3>Sales Bill Item Register</h3>
            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <iframe id="ReportArea" style="display:none;"></iframe>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="SalesBillItemsRegisterList" class="table table-condensed">   
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-right">Round Off Amount</th>
                                                </tr>
                                            </thead>
                                            <tbody></tbody>
                                        </table>
    ...
    <script type="text/javascript" src="../content/scripts/app/mis/Sales-bill-item-register.js"></script>
