...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMaster" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">Salesmanwise Sale Qty Report</h4>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <table id="SalesmanwiseSaleQtyReport" class="table table-condensed">
                                            <%--<thead>
                                                <tr>
                                                    <th>Item Name</th>
                                                    <th>Stock Qty</th>
    ...
    <script type="text/javascript" src="../content/scripts/app/mis/salesmanwise-sale-qty-report.js"></script>
