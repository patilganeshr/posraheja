<%@ Page Title="Job Work Items Balance Qty" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="JobWorkItemBalanceQty.aspx.cs" Inherits="POS.MIS.JobWorkItemBalanceQty" %>
    ...
    <div class="st-content">
        ...
        <div class="container-fluid">
            ...
            <div class="page-header">
                <h3>Job Work Item Balance Qty Report</h3>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <table id="JobWorkItemBalanceQty" class="table table-condensed">                                            
                                        </table>                                        
                                    </div>
