...
SharpiTech.JobWorkItemBalanceQty = (function () {
    ...
    var jobWorkItemsBalanceQtyList = [];
    ...
    function cacheDOM() {
        ...
        DOM.jobWorkItemBalanceQty = document.getElementById('JobWorkItemBalanceQty');
    ...
    function generateReport() {
        ...
        jobWorkItemsBalanceQtyList.length = 0;
    ...
    function bindReportData() {
        ...
        if (jobWorkItemsBalanceQtyList.length > 0) {
            ...
            if (DOM.jobWorkItemBalanceQty.hasChildNodes('thead')) {
                if (DOM.jobWorkItemBalanceQty.tHead !== null) {
                    DOM.jobWorkItemBalanceQty.tHead.remove();
                }
            }

            if (DOM.jobWorkItemBalanceQty.hasChildNodes('tbody')) {
                if (DOM.jobWorkItemBalanceQty.tBodies.length ) {
                    DOM.jobWorkItemBalanceQty.tBodies[0].remove();
                }
            }

            var tableHeader = createTableHeader(jobWorkItemsBalanceQtyList, excludeListOfTableHeaders);
    ...
    function fnExcelReport() {
        ...
        tab = DOM.jobWorkItemBalanceQty; // id of table
...
SharpiTech.JobWorkItemBalanceQty.init();
