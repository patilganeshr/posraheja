<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewSalesBill.aspx.cs" Inherits="POS.Sales.NewSalesBill" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="pull-right">                        
                            <button type="button" class="btn btn-lg btn-primary">Save Bill</button>
                            <button type="button" class="btn btn-lg btn-default">Print Bill</button>
                        </div>
