...
namespace SharpiTech.POS.DataModel
{
    public class Branch
    {
        ...
        public List<Entities.Branch> GetAllBranchNames()
        {
            ...
            try
            {
                using (dbCommand = database.GetStoredProcCommand(DBStoredProcedure.GetAllBranchNames))
                {
        ...
        public List<Entities.Branch> GetBranchesByCompanyId(Int32 companyId)
        {
            ...
            try
            {
                using (dbCommand = database.GetStoredProcCommand(DBStoredProcedure.GetBranchesByCompanyId))
                {
