...
namespace SharpiTech.POS.DataModel
{
    public class AddressType
    {
        ...
        public Entities.AddressType GetAddressTypeById(Int32 addressTypeId)
        {
            ...
            using (dbCommand = database.GetStoredProcCommand(DBStoredProcedure.GetAddressTypeById))
            {
        ...
        public Entities.AddressType GetAddressTypeByName(string addressTypeName)
        {
            ...
            using (dbCommand = database.GetStoredProcCommand(DBStoredProcedure.GetAddressTypeByName))
            {
