...
namespace SharpiTech.POS.DataModel
{
    public class ItemCategory
    {
        ...
        public List<Entities.ItemCategory> GetAllItemCategories()
        {
            ...
            try
            {
                using (dbCommand = database.GetStoredProcCommand(DBStoredProcedure.GetAllItemCategories))
                {
        ...
        public Entities.ItemCategory GetItemCategoryById(Int32 itemCategoryId)
        {
            ...
            using (dbCommand = database.GetStoredProcCommand(DBStoredProcedure.GetItemCategoryById))
            {
        ...
        public Entities.ItemCategory GetItemCategoryByName(string itemCategoryName)
        {
            ...
            using (dbCommand = database.GetStoredProcCommand(DBStoredProcedure.GetItemCategoryByName))
            {
