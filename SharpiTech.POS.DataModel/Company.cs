...
namespace SharpiTech.POS.DataModel
{
    public class Company
    {
        ...
        public List<Entities.Company> GetAllCompanies()
        {
            ...
            try
            {
                using (dbCommand = database.GetStoredProcCommand(DBStoredProcedure.GetAllCompanies))
                {
        ...
        public Entities.Company GetCompanyDetailsByCompanyId(Int32 companyId)
        {
            ...
            try
            {
                using (dbCommand = database.GetStoredProcCommand(DBStoredProcedure.GetCompanyDetailsByCompanyId))
                {
